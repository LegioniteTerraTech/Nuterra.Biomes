...
namespace Nuterra.World.Scenery
{
    ...
    public class ManModScenery : ModLoaderSystem<ManModScenery, SceneryTypes, CustomScenery>
    {
        ...
        public const string ModSceneryName = ManModWorld.ModName + Tag;
        ...
        {
            if (InitPatches || MassPatcher.MassPatchAllWithin(ManModWorld.harmonyInst, typeof(SceneryPatches), ManModWorld.ModName, true))
            {
                InitPatches = true;
                ...
                inst.Log("Rebuilding lookup!");
                SpawnHelper.GrabInitList(true);
                inst.Log("Rebuilding lookup finished!");
            }
            else
        ...
        protected override void FinalAssignment(CustomScenery scenery, SceneryTypes AssignedID)
        {
            ...
            if (!modSceneryModNames.ContainsKey(AssignedIDInt))
            {
                ...
                Log("Assigned Custom Scenery " + scenery.Name + " to ID " + AssignedIDInt);
        ...
        protected override void LoadInstance(ModContainer Mod, string ID, CustomScenery scenery)
        {
            ...
            if (PrefabTO != null)
            {
                ...
                Log("Chunk PrefabName \"" + scenery.PrefabName + "\" does not have a valid prefab instance!" +
